...
public class AuthenticateController extends JSFController {
	...
	// Função responsável por validar o usuário (login e senha). Será chamada na páginade login.
	...
	// Função que checa se o usuário já está logado. Caso contrário, redireciona para a página de login
