...
public class RegisterServiceBean implements RegisterService {
	...
	// Função que checa se já existe um admin no sistema. Caso contrário, cria um
	// usuário
	// admin padrão.
	@Override
...
//				addressDAO.save(target);
	...
	// Função responsável pelo registro de um usuário no sistema. Caso não existe a
	// role
	// de usuário comum, a função irá criar. Todo usuário criado terá a role "User"
	// por padrão.
	...
	// Função responsável por atualizar o usuário com as novas informações
	// fornecidas.
